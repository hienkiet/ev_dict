...
GtkWidget *window,*window_them_tu,*window_sua_tu,*window_infor,*window_help;
...
GdkPixbuf *icon_1,*icon_2;
    ...
    gtk_builder_connect_signals(builder, NULL);
    icon_1 = create_pixbuf("/home/hp/p.jpg");  
    icon_2 = create_pixbuf("/home/hp/EV-Dictionary/glade/ev_dict.jpg");  
    gtk_window_set_icon(GTK_WINDOW(window), icon_1);
    gtk_window_set_icon(GTK_WINDOW(window), icon_2);
